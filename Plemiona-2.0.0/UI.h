...
namespace UI
{
	...
	namespace strings
	{
		...
		inline ClickableBackButton exitBtn(Vector2(208, 72), "WyjdŸ", func::endGameLoop,0,_red);
		...
		inline ClickableBackButton exitBtnStn(208, 72, "WyjdŸ", func::openMainMenu,1,_red);
		...
		inline PercentString musicVol(97, 35, mainSettings::musicVol, "G³oœnoœæ Muzyki: ", 1, 15, 15);
		inline PercentString soundsVol(97, 36, mainSettings::soundsVol, "G³oœnoœæ Odg³osów: ", 1, 15, 15);
	...
	namespace controls
	{
		...
		inline ClickableBackButton delete_all_notBtn(203, 45, "Usuñ Wsz. Pow.",deleteAllNoti, 0,_red);
		...
		inline ClickableString regMapBtn(179, 50, "Mapa Regionów", func::null);
		inline ClickableString gmMapBtn(179, 52, "Mapa Gmin", func::null);
		inline ClickableString roadMapBtn(179, 54, "Mapa Dróg", func::null);
		inline ClickableString militMapBtn(179, 56, "Mapa Militarna", func::null);
		inline ClickableString popMapBtn(179, 58, "Mapa Ludnoœci", func::null);
		inline ClickableString citiesMapBtn(179, 60, "Mapa Miast", func::null);
		inline ClickableString incomeMapBtn(179, 68, "Mapy Przychodów", IncomeMapF);
	...
	inline void stoneIncomeF(GameManager* mgr)
	{
		if (Game::map_type == 8)
		{
			mgr->sound.Play(sound::menuhud);
			Game::income_type = 2;
			UI::controls::incomeMapType.SetText("Kamieñ              ");
			mgr->UpdateMap();
		}
	}
	inline void ironIncomeF(GameManager* mgr)
	...
	inline void foodIncomeF(GameManager* mgr)
	{
		if (Game::map_type == 8)
		{
			mgr->sound.Play(sound::menuhud);
			Game::income_type = 4;
			UI::controls::incomeMapType.SetText("¯ywnoœæ             ");
			mgr->UpdateMap();
		}
	}
	inline void productionIncomeF(GameManager* mgr)
